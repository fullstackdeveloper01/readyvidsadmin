    ...
    {  
       ...
       // $template->template_image = $request->template_image;  
        ...
        if (strpos($html_string,'{font_family1}') !== false) {
            ...
            $html_string= str_replace('{font_family1}',$request->fonts,$html_string);
        }
       //  echo $html_string;//die;                  
        ...
        // $options->set('defaultFont', "'adobe-devanagari-regular', sans-serif;"); // Set a default font if necessary
...
// <link href='https://www.dafontfree.net/embed/YWRvYmUtZGV2YW5hZ2FyaS1yZWd1bGFyJmRhdGEvMzgyL2EvMTkzOTEwL0Fkb2JlRGV2YW5hZ2FyaS1SZWd1bGFyLm90Zg' rel='stylesheet' type='text/css'/>
// <style>
//         body {
       
// font-family: 'adobe-devanagari-regular', sans-serif;
//         }
...
//             src: url(https://admin.readyvids.com/vendor/vendor/dompdf/dompdf/lib/fonts/adobe-devanagari-regular-normal_288c06c312172193a6938f4cab1b914c.otf) format('opentype');
...
//     </style>".$html_string."</html>"); 
    ...
    public function edit(Template $template)
    {
        ...
        $options->set('isPhpEnabled', true);
        $options->set('isFontSubsettingEnabled', true); // Subsetting fonts can reduce file size
        $options->set('defaultFont', "tiro devanagari hindi"); // Set a default font if necessary
        $options->set('fontPath', "https://admin.readyvids.com/vendor/vendor/dompdf/dompdf/lib/fonts/tiro devanagari hindi"); // Set a default font if necessary
        //$options->set('fontDir', 'C:/xampp/htdocs/Blog/vendor/dompdf/dompdf/lib/fonts/');
       ...
       <style>
        @font-face {
            ...
            src: url('https://admin.readyvids.com/vendor/vendor/dompdf/dompdf/lib/fonts/tiro devanagari hindi') format('truetype');
          }
          ...
          body {
            ...
            </style> <p style='font-family: tiro devanagari hindi'>अंतरिक्ष यान से दूर नीचे पृथ्वी शानदार ढंग से जगमगा रही थी । लेकिन चोंकाने वाली बात ये है कि हर Best</p>
 </body></html>";
     
        $dompdf->loadHtml($html); 
        //dd($dompdf);
     $dompdf->render();
     $dompdf->stream("studentidcard.pdf", array("Attachment"=>0));
