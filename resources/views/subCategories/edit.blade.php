...
@section('content')
    @include('categories.partials.header', ['title' => __('Edit Sub category')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">                                
                        <form method="post" action="{{ route('subCategories.update', $categories) }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                            <hr />
