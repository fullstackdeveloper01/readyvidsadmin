                            ...
                            <form method="post" action="{{ route('template.store') }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        -->
                                        <div class="col-md-3 form-group{{ $errors->has('video_type') ? ' has-danger' : '' }}">
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('[backgroundcolor') ? ' has-danger' : '' }}">
                                         ...
                                         <div class="col-md-6 form-group{{ $errors->has('bordercolor') ? ' has-danger' : '' }}">
