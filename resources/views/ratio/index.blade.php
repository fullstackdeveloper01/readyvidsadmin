                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('ratio.create') }}" class="btn btn-sm btn-primary">{{ __('Add Ratio') }}</a>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach ($ratios as $key=> $ratio)
                                    <tr>
                                        ...
                                        @if($ratio->status==1)
                                         <td>
                                            <label class="switch">
                                                <input type="checkbox" id="togBtn" onclick="changeStatus('ratioStatus','{{$ratio->id}}','0')" checked >
                                        ...
                                        <td>
                                            <label class="switch">
                                                <input type="checkbox" id="togBtn" onclick="changeStatus('ratioStatus','{{$ratio->id}}','1')" >
                                                <div class="slider round"></div>
                                            </label>
                                        </td>
                                        @endif
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('ratio.edit', $ratio) }}">{{ __('Edit') }}</a>
