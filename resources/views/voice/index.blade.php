                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 text-right">
                                ...
                                <a href="{{ route('voice.create') }}" class="btn btn-sm btn-primary">{{ __('Upload Multiple Voice') }}</a>
                                <!--<a href="{{ route('image.files_upload') }}" class="btn btn-sm btn-primary">{{ __('Upload Multiple Image') }}</a>-->
                                <a href="{{ route('voice.download') }}" class="btn btn-sm btn-primary">{{ __('Sample Download') }}</a>
                                <a href="{{ route('voice.bulk_upload') }}" class="btn btn-sm btn-primary">{{ __('Bulk Upload') }}</a>
                            </div>
                            <div class="col-4">
                                <form method="get">
                            ...
                            <div class="col-8 text-right">   
                                ...
                                @endphp
                                <a class="btn btn-sm btn-primary" href="{{ route('voice.export') }}?folder_id=<?=$folder_id?>">Export</a>
                                <button type="submit" class="btn btn-sm btn-primary">{{ __('Filter') }}</button>
                            </form>
                                <a href="{{ route('voice.index') }}" class="btn btn-sm btn-primary">{{ __('Clear Filter') }}</a>
                            </div>
                             <div class="col-4">   
                            ...
                            <div class="col-8 text-right">    
                                <div class="row">
                                    ...
                                    <div class="col-2">   
                                        ...
                                        <form action="{{ route('voice.delete_folder') }}" id="deleteForm" method="post">
                                            @csrf
                                            <!--@method('delete')-->
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('Male Short1') }}</th>
                                    <th scope="col">{{ __('Female Short1') }}</th> 
                                    <th scope="col">{{ __('Male Long1') }}</th>
                                    <th scope="col">{{ __('Female Long1') }}</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($voices as $key=> $voice)
                                    ...
                                    <tr>
                                        <td><a href="{{ route('voice.edit', $voice) }}">{{ $key+1 }}</a></td>
                                        <td>{{ $voice->name }}</td>
                                        <td>
                                            <audio controls src="{{ asset($voice->audio_m1) }}" \>
                                        </td>
                                        <td>
                                            <audio controls src="{{ asset($voice->audio_f1) }}" \>
                                        </td>
                                         <td>
                                            <audio controls src="{{ asset($voice->audio_m1_long) }}" \>
                                        </td>
                                         <td>
                                            <audio controls src="{{ asset($voice->audio_f1_long) }}" \>
                                        </td>
                                        <!--@if($voice->status==1)-->
                                        <!-- <td>-->
                                        <!--    <label class="switch">-->
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <form action="{{ route('voice.destroy', $voice) }}" method="post">
                                                        @csrf
                                                        @method('delete')
