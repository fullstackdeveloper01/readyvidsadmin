        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('quiz_video.update', $quiz_video) }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <hr />
                                ...
                                <div class="row">
                                        <div class="col-md-6 form-group{{ $errors->has('template_type_id') ? ' has-danger' : '' }}">
                                            ...
                                            @foreach($templateTypeList as $res)
                                                <option value="{{$res->id}}" @if($quiz_video->template_type_id==$res->id) selected @endif>{{$res->type}}</option>
                                            @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('country_id') ? ' has-danger' : '' }}">
                                            ...
                                            @foreach($countryList as $res)
                                                <option value="{{$res->id}}" @if($quiz_video->country_id==$res->id) selected @endif>{{$res->country_name}}</option>
                                            @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('subject_id') ? ' has-danger' : '' }}">
                                            ...
                                            <select name="subject_id" id="subject_id" class="form-control form-control-alternative{{ $errors->has('subject_id') ? ' is-invalid' : '' }}" required>
                                                <option value="{{$quiz_video->subject_id}}">{{$subject_name->name}} </option>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('option_type_id') ? ' has-danger' : '' }}">
                                            ...
                                            <select name="option_type_id" id="option_type_id" class="form-control form-control-alternative{{ $errors->has('option_type_id') ? ' is-invalid' : '' }}" value="old('option_type_id')" required>
                                                ...
                                                @foreach($optionTypeList as $res)
                                                    <option value="{{$res->id}}" @if($quiz_video->option_type_id==$res->id) selected @endif>{{$res->type}}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('topic_id') ? ' has-danger' : '' }}">
                                            ...
                                            <option value="{{$quiz_video->topic_id}}">{{$topic_name->name}} </option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group{{ $errors->has('audio1') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio1" id="audio1" class="form-control form-control-alternative{{ $errors->has('audio1') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker1 Question Audio</label>
                                            @if(!is_null($quiz_video->audio1))
                                            <audio controls src="{{ asset($quiz_video->audio1) }}" type="audio/*"> </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('answer_audio1') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="answer_audio1" id="answer_audio1" class="form-control form-control-alternative{{ $errors->has('answer_audio1') ? ' is-invalid' : '' }}" >
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker1 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio1))
                                            <audio controls src="{{ asset($quiz_video->answer_audio1) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div> 
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker2 Question Audio</label>
                                            @if(!is_null($quiz_video->audio2))
                                            <audio controls src="{{ asset($quiz_video->audio2) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker2 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio2))
                                            <audio controls src="{{ asset($quiz_video->answer_audio2) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker3 Question Audio</label>
                                            @if(!is_null($quiz_video->audio3))
                                            <audio controls src="{{ asset($quiz_video->audio3) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker3 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio3))
                                            <audio controls src="{{ asset($quiz_video->answer_audio3) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker4 Question Audio</label>
                                            @if(!is_null($quiz_video->audio4))
                                            <audio controls src="{{ asset($quiz_video->audio4) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker4 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio4))
                                            <audio controls src="{{ asset($quiz_video->answer_audio4) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker5 Question Audio</label>
                                            @if(!is_null($quiz_video->audio5))
                                            <audio controls src="{{ asset($quiz_video->audio5) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker5 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio5))
                                            <audio controls src="{{ asset($quiz_video->answer_audio5) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker6 Question Audio</label>
                                            @if(!is_null($quiz_video->audio6))
                                            <audio controls src="{{ asset($quiz_video->audio6) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker6 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio6))
                                            <audio controls src="{{ asset($quiz_video->answer_audio6) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker7 Question Audio</label>
                                            @if(!is_null($quiz_video->audio7))
                                            <audio controls src="{{ asset($quiz_video->audio7) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker7 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio7))
                                            <audio controls src="{{ asset($quiz_video->answer_audio7) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker8 Question Audio</label>
                                            @if(!is_null($quiz_video->audio8))
                                            <audio controls src="{{ asset($quiz_video->audio8) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker8 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio8))
                                            <audio controls src="{{ asset($quiz_video->answer_audio8) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker9 Question Audio</label>
                                            @if(!is_null($quiz_video->audio9))
                                            <audio controls src="{{ asset($quiz_video->audio9) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker9 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio9))
                                            <audio controls src="{{ asset($quiz_video->answer_audio9) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker10 Question Audio</label>
                                            @if(!is_null($quiz_video->audio10))
                                            <audio controls src="{{ asset($quiz_video->audio10) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker10 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio10))
                                            <audio controls src="{{ asset($quiz_video->answer_audio10) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker11 Question Audio</label>
                                            @if(!is_null($quiz_video->audio11))
                                            <audio controls src="{{ asset($quiz_video->audio11) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker11 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio11))
                                            <audio controls src="{{ asset($quiz_video->answer_audio11) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker12 Question Audio</label>
                                            @if(!is_null($quiz_video->audio12))
                                            <audio controls src="{{ asset($quiz_video->audio12) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker12 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio12))
                                            <audio controls src="{{ asset($quiz_video->answer_audio12) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker13 Question Audio</label>
                                            @if(!is_null($quiz_video->audio13))
                                            <audio controls src="{{ asset($quiz_video->audio13) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker13 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio13))
                                            <audio controls src="{{ asset($quiz_video->answer_audio13) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker14 Question Audio</label>
                                            @if(!is_null($quiz_video->audio14))
                                            <audio controls src="{{ asset($quiz_video->audio14) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker14 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio14))
                                            <audio controls src="{{ asset($quiz_video->answer_audio14) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker15 Question Audio</label>
                                            @if(!is_null($quiz_video->audio15))
                                            <audio controls src="{{ asset($quiz_video->audio15) }}" type="audio/*">
                                            </audio>
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Selected Speaker15 Answer Audio</label>
                                            @if(!is_null($quiz_video->answer_audio15))
                                            <audio controls src="{{ asset($quiz_video->answer_audio15) }}" type="audio/*">
                                            </audio>
                                            @endif
            ...
            var template_type = $("#template_type_id option:selected").text();
                ...
                if(lineno[0]>0){
                    for(var index=0;index<=lineno[0];index++){
                        if(index==0){
                            var text="Question";
                            var display_text = "{{$quiz_video->question}}";
                            
                        }else if(index==lineno[0]){
                            var text="Answer";
                            var display_text = "{{$quiz_video->answer}}";
                        }else{
                            var text="Option"+index;
                            var column_name= "option"+index;
                            if(index==1)
                            var display_text = "{{$quiz_video->option1}}";
                            else if(index==2)
                                var display_text = "{{$quiz_video->option2}}";
                            else if(index==3)
                                var display_text = "{{$quiz_video->option3}}";
                            else if(index==4)
                                var display_text = "{{$quiz_video->option4}}";
                            else if(index==(lineno[0]-1))
                                var display_text = "{{$quiz_video->option5}}";
                         ...
                         html += "<div class='col-md-6 form-group{{ $errors->has('text1') ? ' has-danger' : '' }}'>"+
                                    ...
                                    '<input type="text" name="text[]" id="text1" class="form-control form-control-alternative{{ $errors->has("text1") ? " is-invalid" : "" }}" value="'+display_text+'" required>'+
