  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{ route('image.make_folder') }}" autocomplete="off" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade" id="folderUpdateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{ route('image.update_folder') }}" autocomplete="off" enctype="multipart/form-data">
            @csrf
