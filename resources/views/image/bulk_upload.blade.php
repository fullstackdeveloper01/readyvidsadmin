@extends('layouts.app', ['title' => __('Image Management')])

@section('content')
    @include('image.partials.header', ['title' => __('Add Image')])
            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('image.bulk_upload') }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <!-- </div> -->
                                <div class="pl-lg-4">  
