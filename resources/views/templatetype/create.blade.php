...
@section('content')
    ...
    @include('templatetype.partials.header', ['title' => __('Add Template Type')])
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <form method="post" action="{{ route('templatetype.store') }}" autocomplete="off" enctype="multipart/form-data">
