...
@section('content')
    ...
    @include('templatetype.partials.header', ['title' => __('Edit Template Type')])
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-header bg-white border-0">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                ...
                                <a href="{{ route('templatetype.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <form method="post" action="{{ route('templatetype.update',$templatetype) }}" autocomplete="off" >
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-12 form-group{{ $errors->has('[type') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="type" id="type" class="form-control form-control-alternative{{ $errors->has('type') ? ' is-invalid' : '' }}" placeholder="{{ __('Type') }}" value="{{old('type')}}{{$templatetype->type}}" required>
