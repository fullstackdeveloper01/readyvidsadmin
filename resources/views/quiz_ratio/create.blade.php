            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('quiz_ratio.store') }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                </div>
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('value') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="value" id="value" class="form-control form-control-alternative" placeholder="{{ __('ratio value') }}" value="{{ old('value') }}">
                                        @if ($errors->has('value'))
                                            <span class="invalid-feedback" role="alert">
