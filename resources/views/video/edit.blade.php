...
@section('content')
    @include('video.partials.header', ['title' => __('Edit Video')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('video.update', $video) }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <hr />
                                ...
                                <div class="pl-lg-4">
                                    <div class="row">
                                        <div class="col-md-6 form-group{{ $errors->has('section') ? ' has-danger' : '' }}">
                                            ...
                                            @foreach($sectionList as $res)
                                                <option value="{{$res->id}}"  @if($video->section==$res->id) selected @endif>{{$res->name}}</option>
                                            @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('template_type') ? ' has-danger' : '' }}">
                                            ...
                                            @foreach($templateTypeList as $res)
                                                <option value="{{$res->id}}" @if($video->template_type==$res->id) selected @endif>{{$res->type}}</option>
                                            @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('primary_language') ? ' has-danger' : '' }}">
                                            ...
                                            @foreach($primaryLanguageList as $res)
                                                <option value="{{$res->id}}" @if($video->primary_language==$res->id) selected @endif>{{$res->name}}</option>
                                            @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('secondary_language') ? ' has-danger' : '' }}">
                                            ...
                                            <select name="secondary_language" id="secondary_language" class="form-control form-control-alternative{{ $errors->has('secondary_language') ? ' is-invalid' : '' }}" value="old('secondary_language')" required>
                                                <option value=""> -- </option>
                                                @foreach($secondaryLanguageList as $res)
                                                <option value="{{$res->id}}" @if($video->secondary_language==$res->id) selected @endif>{{$res->name}}</option>
                                                @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('category') ? ' has-danger' : '' }}">
                                            ...
                                            @foreach($categoryList as $res)
                                                <option value="{{$res->id}}" @if($video->category==$res->id) selected @endif>{{$res->name}}</option>
                                            @endforeach
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('subcategory') ? ' has-danger' : '' }}">
                                            ...
                                            <select name="subcategory" id="subcategory" class="form-control form-control-alternative{{ $errors->has('subcategory') ? ' is-invalid' : '' }}" value="old('subcategory')" required>
                                                <option value=""> -- </option>
                                            @foreach($subcategoryList as $res)
                                                <option value="{{$res->id}}" @if($video->subcategory==$res->id) selected @endif>{{$res->name}}</option>
                                            @endforeach
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img width="100px" height="100px" src="{{ asset("{$video->image}") }}">
                                        </div>
                                        ...
                                        <input type="file" name="audio_m" id="audio_m" class="form-control form-control-alternative{{ $errors->has('audio_m') ? ' is-invalid' : '' }}" value="">
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male1 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_m) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m1') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m1" id="audio_m1" class="form-control form-control-alternative{{ $errors->has('audio_m1') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male2 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_m1) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m2') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m2" id="audio_m2" class="form-control form-control-alternative{{ $errors->has('audio_m2') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male3 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_m2) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m3') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m3" id="audio_m3" class="form-control form-control-alternative{{ $errors->has('audio_m3') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male4 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_m3) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m4') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m4" id="audio_m4" class="form-control form-control-alternative{{ $errors->has('audio_m4') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male5 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_m4) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f" id="audio_f" class="form-control form-control-alternative{{ $errors->has('audio_f') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female1 (Short)</label>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f1') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f1" id="audio_f1" class="form-control form-control-alternative{{ $errors->has('audio_f1') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female2 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_f1) }}" type="audio/*">
                                            </audio>
                                        </div>
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f2') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f2" id="audio_f2" class="form-control form-control-alternative{{ $errors->has('audio_f2') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female3 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_f3) }}" type="audio/*">
                                            </audio>
                                        </div>
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f3') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f3" id="audio_f3" class="form-control form-control-alternative{{ $errors->has('audio_f3') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female4 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_f3) }}" type="audio/*">
                                            </audio>
                                        </div>
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f4') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f4" id="audio_f4" class="form-control form-control-alternative{{ $errors->has('audio_f4') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female5 (Short)</label>
                                            <audio controls src="{{ asset($video->audio_f4) }}" type="audio/*">
                                            </audio>
                                        </div>
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m1') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m1_long" id="audio_m1_long" class="form-control form-control-alternative{{ $errors->has('audio_m1_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male1 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_m1_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m2_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m2_long" id="audio_m2_long" class="form-control form-control-alternative{{ $errors->has('audio_m2_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male2 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_m2_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m3_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m3_long" id="audio_m3_long" class="form-control form-control-alternative{{ $errors->has('audio_m3_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male3 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_m3_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m4_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m4_long" id="audio_m4_long" class="form-control form-control-alternative{{ $errors->has('audio_m4_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male4 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_m4_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_m5_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_m5_long" id="audio_m5_long" class="form-control form-control-alternative{{ $errors->has('audio_m5_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Male5 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_m5_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f1_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f1_long" id="audio_f1_long" class="form-control form-control-alternative{{ $errors->has('audio_f1_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female1 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_f1_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f2_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f2_long" id="audio_f2_long" class="form-control form-control-alternative{{ $errors->has('audio_f2_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female2 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_f2_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f3_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f3_long" id="audio_f3_long" class="form-control form-control-alternative{{ $errors->has('audio_f3_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female3 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_f3_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f4_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f4_long" id="audio_f4_long" class="form-control form-control-alternative{{ $errors->has('audio_f4_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female4 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_f4_long) }}" type="audio/*">
                                            </audio>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('audio_f5_long') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="audio_f5_long" id="audio_f5_long" class="form-control form-control-alternative{{ $errors->has('audio_f5_long') ? ' is-invalid' : '' }}" value="" >
                                        ...
                                        <div class="form-group">
                                            <label>Selected Audio Female5 (Long)</label>
                                            <audio controls src="{{ asset($video->audio_f5_long) }}" type="audio/*">
                                            </audio>
                                    ...
                                    <div class="row" id="textfield">
                                        @if(count($videoTexts)!=0)
                                            @foreach($videoTexts as $key=>$videoText)
                                                <div class="col-md-6 form-group{{ $errors->has('text2') ? ' has-danger' : '' }}">
    
                                                    <label class="form-control-label" for="color">{{ __('Text') }}{{$key+1}}</label>
    
                                                    <input type="text" name="text[]" id="text2" class="form-control form-control-alternative{{ $errors->has('text2') ? ' is-invalid' : '' }}" value="{{old('text2')}}{{$videoTexts[$key]->text}}" required>
