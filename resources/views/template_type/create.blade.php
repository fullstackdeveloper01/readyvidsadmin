...
@section('content')
    ...
    @include('template_type.partials.header', ['title' => __('Add Template Type')])
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <form method="post" action="{{ route('template_type.store') }}" autocomplete="off" enctype="multipart/form-data">
