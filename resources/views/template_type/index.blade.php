                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('template_type.create') }}" class="btn btn-sm btn-primary">{{ __('Add Template Type') }}</a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('template_type.edit', $template) }}">{{ __('Edit') }}</a>
                                                    <form action="{{ route('template_type.destroy', $template) }}" method="post">
                                                        @csrf
                                                        @method('delete')
