								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">Thank you for your interest in the ReadyVids Affiliate Program! We are currently reviewing your application with the care and attention it deserves. Our goal is to ensure that every new affiliate is a perfect match for our innovative e-learning platform.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Should we require any further information to complete our review, one of our dedicated team members will reach out to you directly via phone or email.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">We will aim to finalize our evaluation and respond with our decision within [timeframe, e.g., one week]. Your patience during this process is greatly appreciated.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">We're excited about the prospect of you joining our affiliate community and thank you for considering ReadyVids as your partner in growth.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:20px; margin-bottom:0;">Warm regards,</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; font-weight:600; margin-top:5px">The ReadyVids Affiliate Program Team</p>
