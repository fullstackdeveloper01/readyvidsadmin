								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">Forgot your password?</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">We received a request to reset the password for your account.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">Here is your Login Details. </p>
											<p style="color:#FFFFFF; border-radius:3px; font-family:'Poppins', sans-serif; margin:30px 0; background-color:transparent; border:2px dashed #e6a051; padding:14px; font-size:14px; text-align:left; display:block;"> 
												<span>Your Email: {{$email}}</span><br>
												<span>OTP: {{$password}}</span>
											</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">If this was a mistake, just ignore this email and nothing will happen.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">If any Questions? Please send us an email at <a href="mailto:support@readyvids.com" style="color:#e6a051 !important">support@readyvids.com</a> and we will revert as soon as possible.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:20px; margin-bottom:0;">Best Regards</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; font-weight:600; margin-top:5px">ReadyVids Team</p>
										</td>
									</tr>
								</table>
							</td>
