								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">Congratulations on upgrading to the Premium Plan! </p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Get ready to harness the best of what ReadyVids has to offer: advanced features, seamless video creation, and priority support. Your journey to exceptional content creation begins now.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Thank you for your trust in ReadyVids. Happy creating!</p>
											
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:20px; margin-bottom:0;">Best,</p>
