								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">We've loved watching the incredible content you've produced with ReadyVids, and we're here with a friendly heads-up: you've fully utilized the short video quota of your current plan. But why stop now?</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Upgrade Your Plan: Dive into our array of plans and select one that matches your growing creative needs, complete with a higher number of short videos and additional exciting features.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Review Your Usage: Take a moment to visit your dashboard, where you can monitor your video usage and find the perfect plan that keeps pace with your creativity.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Remember, creating impactful videos is key, and we're dedicated to ensuring your creative flow is never disrupted.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">If you need any advice or support, our team is just a message away, ready to help you continue your creative journey.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:20px; margin-bottom:0;">Keep on creating,</p>
