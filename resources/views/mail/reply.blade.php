<!DOCTYPE html>
	<head>
		...
		<title>EyeKandy Emailer || Support</title>
								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									<tr>
										<td class="logo" style="padding:40px 0 30px 0; text-align:center; border-bottom:1px solid #E1E1E1">
											<img src="{{asset('logo.png')}}" alt="EyeKandy" title="EyeKandy"/>
											<h2 style="font-family:'Poppins', sans-serif; font-size:25px; color:#fff; margin-top:10px;letter-spacing:1px;">Welcome to Ready Vids</h2>
										</td>
									</tr>
									<tr>
										<td class="content" style="padding:40px 40px;" id="supportreply">
										    <span style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:10px;">
										    {!! $message !!}
										    </span>
										    <p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">If any Questions? Please send us an email at <a href="mailto:support@readyvids.com" style="color:#ec297b !important">support@readyvids.com</a> and we will revert as soon as possible.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:20px; margin-bottom:0;">Best Regards</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; font-weight:600; margin-top:5px">Ready Vids Team</p>
										</td>
									</tr>
								</table>
							</td>
