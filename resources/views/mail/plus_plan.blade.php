								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">Kudos on stepping up to the Plus Plan!</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Unlock a richer set of tools and functionalities that will elevate your video creation journey. It's time to explore more with ReadyVids.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Thank you for being with us. Let's create something awesome!</p>
