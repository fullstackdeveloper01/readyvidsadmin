								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0">Welcome to the Basic Plan!</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Dive into enhanced features and better video creation capabilities tailored just for you. We're excited for you to experience this upgrade.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">Thank you for choosing ReadyVids. Start crafting!</p>
