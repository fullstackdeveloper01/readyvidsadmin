<!DOCTYPE html>
	<head>
		...
		<title>ReadyVids Emailer || Changed Password</title>
								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:0"><a href="<?php echo Config::get('app.url'); ?>set_password/{{$email}}">Please click on link and set Password.</a></p>
